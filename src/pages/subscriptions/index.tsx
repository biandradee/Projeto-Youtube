...
import SubsIcon from '../../assets/inscrições.png';
        ...
        <MainContainer>
            ...
            <div style={{ width: '100%', display: 'flex' }}>
                ...
                <div style={{ width: '100%', padding: '50px 30px', display: 'flex', justifyContent: 'center' }}>
                    <Container>
                        <ContainerImage alt="" src={SubsIcon}/>
                        <TextContainer>
                            <Title>Não perca novos vídeos</Title>
                            <span>Faça login para ver as atualizações dos seus canais favoritos do YouTube.</span>
                        </TextContainer>
                        <ContainerLogin>
